...
def stage_2_main():
    ...
    # generated_rules = load_json_data('result\GDELT\stage_2\historical_data_rule_dict_output.json')
    generated_rules = load_json_data('result\YAGO\stage_2\historical_data_rule_dict_output.json')
