...
def parse_args():
    ...
    parser.add_argument('--graph_reasoning_type', type=str,
                        ...
                        default='timestamp')
    parser.add_argument("--rule_weight", default=0.6, type=float)
    parser.add_argument("--llm_weight", default=0.4, type=float)
...
def stage_5_main():
    ...
    rule_candidates_file = "reasoning_result_1_half.json"
    ...
    test_data = data.test_data_idx[:7371] if (args['test_data'] == "test") else data.valid_idx
