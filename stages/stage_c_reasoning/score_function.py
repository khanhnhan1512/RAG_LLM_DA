...
def score2(cands_walks, test_query_ts, lmbda):
    ...
    score = np.exp(lmbda * (max_cands_ts - test_query_ts))
    return score
...
def score_12(rule, cands_walks, test_query_ts, corr, lmbda, a, confidence_type, weight, min_conf, coor_weight):
    ...
    Returns:
        score (float): candidate score
    """
    score = a * score1(rule, 0, confidence_type, weight) + (1-a) * score2(cands_walks, test_query_ts, lmbda) + coor_weight * corr
    return score
...
def score_14(rule, cands_walks, test_query_ts, corr, lmbda, a, confidence_type, weight, min_conf, coor_weight):
    ...
    Returns:
        score (float): candidate score
    """
    score = a * score1(rule, 0, confidence_type, weight) + (1-a)*score4(cands_walks, test_query_ts, lmbda, rule) + coor_weight * corr
    return score